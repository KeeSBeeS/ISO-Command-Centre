...
@endphp
<style>
    .calendar-toolbar{display:flex;justify-content:space-between;gap:16px;align-items:flex-start;margin-bottom:14px}.calendar-grid{display:grid;grid-template-columns:repeat(7,1fr);gap:8px}.calendar-weekday{font-size:12px;font-weight:900;text-transform:uppercase;letter-spacing:.08em;color:var(--muted);padding:0 8px 6px}.calendar-day{min-height:138px;border:1px solid var(--line);border-radius:16px;padding:10px;background:rgba(15,23,42,.035)}.calendar-day.outside{opacity:.45;background:rgba(15,23,42,.02)}.calendar-day.today{border-color:rgba(139,220,101,.65);box-shadow:0 0 0 1px rgba(139,220,101,.15) inset}.calendar-date{display:flex;align-items:center;justify-content:space-between;font-weight:900;margin-bottom:8px}.calendar-date small{font-weight:700;color:var(--muted)}.calendar-event{display:block;border-radius:12px;padding:7px 8px;margin-top:6px;background:rgba(15,23,42,.055);border:1px solid var(--line);font-size:12px;text-decoration:none;color:var(--text);line-height:1.35}.calendar-event strong{display:block}.calendar-event .meta{color:var(--muted)}.calendar-event.public_holiday{background:rgba(245,185,76,.16);border-color:rgba(245,185,76,.35);color:#8a5a06}.calendar-event.leave{background:rgba(18,163,116,.16);border-color:rgba(139,220,101,.22)}.calendar-event.employee_document,.calendar-event.vehicle_document{background:rgba(78,160,255,.14);border-color:rgba(78,160,255,.28)}.calendar-event.vehicle_service{background:rgba(255,137,74,.15);border-color:rgba(255,137,74,.28)}.calendar-event.attendance{background:rgba(255,74,74,.13);border-color:rgba(255,74,74,.3)}.calendar-event.tracking{background:rgba(152,112,255,.14);border-color:rgba(152,112,255,.3)}.calendar-event.pending,.calendar-event.warning,.calendar-event.late,.calendar-event.overdue,.calendar-event.expired{box-shadow:0 0 0 1px rgba(245,185,76,.12) inset}.calendar-more{font-size:12px;color:var(--muted);margin-top:6px}.legend{display:flex;flex-wrap:wrap;gap:8px}.legend span{border:1px solid var(--line);border-radius:999px;padding:7px 10px;font-size:12px;color:var(--muted);background:rgba(15,23,42,.035)}.calendar-filter-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px}.calendar-filter-tile{border:1px solid var(--line);background:rgba(15,23,42,.035);border-radius:14px;padding:10px;display:flex;gap:8px;align-items:center;font-weight:800}.calendar-filter-tile input{width:18px;height:18px}.calendar-filter-tile .filter-icon{font-size:18px}.calendar-filter-actions{display:flex;gap:8px;flex-wrap:wrap;justify-content:flex-end;margin-top:12px}.reminder-list{display:grid;gap:8px}.reminder-row{display:flex;justify-content:space-between;gap:12px;align-items:center;border:1px solid var(--line);border-radius:14px;padding:10px;background:rgba(15,23,42,.035)}.reminder-row a{text-decoration:none;color:var(--text)}@media(max-width:1100px){.calendar-filter-grid{grid-template-columns:repeat(2,1fr)}}@media(max-width:920px){.calendar-grid{grid-template-columns:repeat(2,1fr)}.calendar-weekday{display:none}.calendar-toolbar{display:block}.calendar-toolbar .actions{margin-top:12px}.calendar-day{min-height:auto}}@media(max-width:620px){.calendar-grid,.calendar-filter-grid{grid-template-columns:1fr}.reminder-row{display:block}.reminder-row .actions{margin-top:8px}.calendar-filter-actions{justify-content:flex-start}.calendar-filter-actions .btn{width:100%}}
</style>
