...
<div class="app">
    ...
    <main class="main">
        ...
        <section class="content">
            ...
            @endif
            @yield('content')
            <div class="footer-note">ISO Admin Command Framework {{ \Illuminate\Support\Facades\Schema::hasTable('system_settings') ? 'v'.(\App\Models\SystemSetting::valueFor('platform_version', '2.9.0')) : 'v2.9.0' }} · isoadmin.co.za</div>
        </section>
    </main>
</div>
@auth
