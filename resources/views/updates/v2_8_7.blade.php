@extends('layouts.app')
@section('title','Update v2.8.7 | ISO Admin')
@section('page_title','Version 2.8.7 Update')
@section('content')
<div class="card">
    ...
    <form method="post" action="{{ route('updates.v2_8_7.apply') }}" style="margin-top:18px">
        @csrf
        <button class="btn primary" type="submit">Apply v2.8.7 Update</button>
    </form>
</div>
@endsection
